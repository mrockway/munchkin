...
class ImageViewController: UIViewController {
    ...
    func findWeek() {
        ...
        if( compare  == true ) {
            ...
            let weeksLeft = Int(ceil(weeks))
            weekNumber.text = "Your baby is in week \( weeksLeft + 40 )"
            weeklyImage.image = UIImage(named: "\(String(weeksLeft + 40))")
            comparisonText.text = "\(data[weeksLeft + 40].comparison)"
        }
    }
    ...
    let data = [
        ...
        (week: "39", length: "19.96 inches", weight: "7.25 pounds", comparison: ""),
        (week: "38", length: "19.61 inches", weight: "6.80 pounds", comparison: "Indy's fedora"),
        (week: "37", length: "19.13 inches", weight: "6.30 pounds", comparison: ""),
        (week: "36", length: "18.66 inches", weight: "5.78 pounds", comparison: ""),
        (week: "35", length: "18.19 inches", weight: "5.25 pounds", comparison: ""),
        (week: "34", length: "17.72 inches", weight: "4.73 pounds", comparison: "a baseball glove"),
        (week: "33", length: "17.20 inches", weight: "4.23 pounds", comparison: ""),
        ...
        (week: "21", length: "10.51 inches", weight: "2.70 ounces", comparison: ""),
        ...
        (week: "17", length: "5.12 inches",	weight: "4.94 ounces", comparison: ""),
        ...
        (week: "41", length: "20.35 inches", weight: "7.93 pounds", comparison: " "),
        (week: "42", length: "20.28 inches", weight: "8.12 pounds", comparison: " ")]
